  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <button
        ...
        className='mt-5 flex w-3/4 transform items-center justify-center rounded-lg bg-[#E52E1C] py-2 shadow-md transition duration-200 hover:scale-105 focus:outline-none'>
        <ImYoutube className='h-6 w-6 text-white' />
        <p className='pl-2 text-xs font-bold text-white'>Continue with Youtube</p>
      </button>
      <button
        ...
        <p className='my-1 pl-2 text-xs font-bold text-white'>Continue with Twitch</p>
      </button>
    </div>
  )
}
