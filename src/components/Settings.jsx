          ...
          <div className='md:inline-flex space-y-4 md:space-y-0 w-full p-4 text-gray-00 items-center'>
            ...
            <div className='flex flex-col gap-1 md:w-2/3 max-w-sm mx-auto'>
              ...
              <div className='md:inline-flex w-full space-y-4 md:space-y-0 pt-10 text-gray-500 justify-end'>
                <div className=''>
                  <button className='text-white bg-indigo-500 w-full mx-auto max-w-sm rounded-md text-center bg-blue-00 py-2 px-4 inline-flex items-center focus:outline-none md:float-right justify-center'>
                    Save
                  </button>
                </div>
              </div>
