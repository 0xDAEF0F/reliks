          ...
          <div className='mx-5 w-full md:mx-10'>
            ...
            <div className='relative'>
              ...
              <input
                id='search'
                name='search'
                className='w-full rounded-md border-light-bordergray bg-white pl-10 shadow-sm focus:border-light-violet7 focus:ring-light-violet7 dark:border-mauve dark:bg-darkMode-violet2 dark:focus:border-darkMode-violet7 dark:focus:ring-darkMode-violet7 sm:text-sm'
