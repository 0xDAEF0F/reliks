...
const navigation = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/reliks_app/',
    icon: (props) => (
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/reliks_app',
    icon: (props) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
  ...
  {
    name: 'Discord',
    href: 'https://discord.gg/z4sTPqGm3p',
    icon: (props) => (
      <svg width='71' height='55' viewBox='0 0 71 55' {...props} fill='currentColor'>
