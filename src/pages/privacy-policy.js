...
function PrivacyPolicy() {
  return (
    <>
      <h1>Privacy Policy for Reliks</h1>
      <p>
      ...
      <h2>Log Files</h2>
      <p>
        Reliks follows a standard procedure of using log files. These files log visitors
      ...
      <p>
        ...
        appear on Reliks, which are sent directly to users' browser. They automatically
      ...
      <p>
        Note that Reliks has no access to or control over these cookies that are used by
        third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Reliks's Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <p>
        ...
        collect in Reliks. This policy is not applicable to any information collected
